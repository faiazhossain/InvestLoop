        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div>
            ...
            >
              ...
              <p className="text-lg text-indigo-100/80 max-w-md leading-relaxed">
                Access your portfolio, track returns, and stay in sync with your
                team&apos;s investment performance.
              </p>
            </motion.div>
            ...
            >
              {["Portfolio insights", "Real-time sync", "Secure access"].map(
                (feature, i) => (
                  <span
                    key={i}
          ...
          >
            <p className="text-white/90 mb-4 leading-relaxed">
              &ldquo;The dashboard gives me instant visibility into our
              investment performance. It&apos;s become essential to how we
              operate.&rdquo;
            </p>
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-white font-medium text-sm">Michael Torres</p>
                <p className="text-indigo-200/70 text-sm">Portfolio Analyst</p>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      >
        <div className="w-full max-w-[440px]">
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.3, duration: 0.5 }}
            className="bg-white dark:bg-slate-900/50 dark:backdrop-blur-xl rounded-2xl shadow-2xl shadow-slate-200/50 dark:shadow-slate-950/50 p-8 border border-slate-100 dark:border-slate-800"
          >
              ...
              appearance={{
                elements: {
                  ...
                  socialButtonsBlockButton:
                    "bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-700 transition-all duration-200 rounded-xl h-11 font-medium text-slate-700 dark:text-slate-200",
                  ...
                  formFieldInput:
                    "rounded-xl border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 h-11 focus:border-indigo-500 focus:ring-indigo-500 dark:focus:border-indigo-400 transition-all duration-200 text-slate-900 dark:text-white placeholder:text-slate-400",
                  formButtonPrimary:
                    "bg-indigo-600 hover:bg-indigo-700 rounded-xl h-11 text-sm font-semibold shadow-lg shadow-indigo-500/25 hover:shadow-indigo-500/40 transition-all duration-200",
                  footerActionLink:
